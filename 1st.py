...
1. keywords: is, or, while, if , else, for, True, False, bool, and, etc.
...
3.operators: i.arthmatic operators (+,-,*,/,//,**,%)
             ...
             ix. arthmatic-assignment operators (/=, *=, -=, +=, %=, //=, **=)
...
data types : int for integer number, 
            float for floting or fractional number 
